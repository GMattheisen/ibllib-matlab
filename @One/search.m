...
SEARCH_TERMS = {  ...
    ...
    'winstor_session', 'winstor_session';...
    'winstorsession', 'winstor_session';...
    'winstor_sessions', 'winstor_session';...
    'winstorsession', 'winstor_session';...
    'winstorsessions', 'winstor_session';...    
    'project', 'project';...
    'projects', 'project';...
    'subject', 'subject';...
    'subjects', 'subject';...
...
%% Handle parameters
p = inputParser;
% automatically create the parameters according to the search terms (date
